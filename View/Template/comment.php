<div class="display_comment_content">
    ...
    <a href="chapitre?id=<?= $this->getChapter(); ?>" class="comment_title_link"><?= $chapter->displayTitleAdmin($this->getChapter()); ?></a>
    <p>Par <?= $this->getUser(); ?></p>
    ...
    ?>
        ...
        <input type="text" name="id" class="reports_comment" value="<?= $this->getChapter(); ?>" />
