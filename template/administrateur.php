...
<div id="content_admin">
    ...
    <div id="content_form_admin">
        <form action="AdministrateurController" method="POST">
            ...
            <input id="chapter_titre" type="text" name="title" placeholder="Titre" alt="titre"> <?php if (array_key_exists('id', $_GET)) {echo 'value="' . $chapter->displayTitle($_GET['id']) . '"';} ?> />
            ...
            <div id="Content_button_chapter_admin">
                <input type="submit" name="buttonSave" value="Enregistrer" id="save_chapter_admin" alt="enregistrer" />
                <?php if (array_key_exists('id', $_GET)): ?>
                <input type="submit" name="buttonDelete" value="Effacer" id="delete_chapter_admin" alt="effacer" />
                <?php endif; ?>
            </div>
        </form>
    </div>    
